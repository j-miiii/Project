...
async;
sendAssignmentRefreshNotification(hospitalId, number, payload, any);
{
    try {
        const userRepository = this.getRepository('users');
        const users = await userRepository.find({
...
async;
generateMockAssignment(hospitalId, number, wardId ?  : number);
{
    try {
...
//# sourceMappingURL=app.service_2.js.map